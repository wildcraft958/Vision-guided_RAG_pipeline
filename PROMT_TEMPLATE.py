...
15. SPECIAL CONTENT TYPES
    ...
    *   Summarize infographics like tables, charts, and images to capture their key information. !!IMPORTANT
    *   Convert all mathematical formulas, equations, and notation into LaTeX syntax exactly as in the source and verify the LaTeX is syntactically correct. !!IMPORTANT
